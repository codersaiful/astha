...
if( ! function_exists( 'medilac_menu' ) ){
    ...
    function medilac_menu(){
        ...
        add_menu_page( esc_html__( 'Medilac', 'medilac' ), esc_html__( 'Medilac', 'medilac' ), $capability, 'medilac_welcome', 'medilac_welcome', $icon, '59' );
        add_submenu_page( 'medilac_welcome', esc_html__( 'Welcome to Medilac', 'medilac' ), esc_html__( 'Welcome', 'medilac' ), $capability, 'medilac_welcome', 'medilac_welcome', 0 );
