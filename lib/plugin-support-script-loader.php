...
if( ! function_exists( 'astha_third_party_plugin_supports' ) ){
    ...
    function astha_third_party_plugin_supports() {
        ...
        if( class_exists( 'WPT_Product_Table' ) ){
            wp_enqueue_style( 'astha-woo-product-table', $base_file . 'woo-product-table.css', array(), ASTHA_VERSION );
        }
        
        if( defined( 'YITH_WCWL_INIT' ) ){
            wp_enqueue_style( 'astha-yith-wishlist', $base_file . 'yith-wishlist.css', array(), ASTHA_VERSION );
        }
        
        if( defined( 'YITH_WCQV_INIT' ) ){
            wp_enqueue_style( 'astha-quick-view', $base_file . 'yith-quick-view.css', array(), ASTHA_VERSION );
        }
        
        if( class_exists( 'WQPMB_Button' ) ){
            wp_enqueue_style( 'astha-plus-minus-button', $base_file . 'wcqbm.css', array(), ASTHA_VERSION );
        }
...
//        }
        ...
        //jQuery appear js
        //wp_enqueue_script( 'jquery-appear', get_template_directory_uri() . '/assets/vendor/js/jquery.appear.js', array('jquery'), ASTHA_VERSION, true );
