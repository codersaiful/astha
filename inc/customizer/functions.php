...
function astha_customize_preview_js() {
	...
	//wp_enqueue_script( 'astha-customizer-preview', get_template_directory_uri() . '/inc/customizer/assets/js/customizer-preview.js', array( 'customize-preview' ), ASTHA_VERSION, true );
	
    //Generated by Underscore
    wp_enqueue_script( 'astha-customizer', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-preview' ), ASTHA_VERSION, true );
    //$ASTHA_CUSTOMIZER = get_theme_mods();
    //$ASTHA_CUSTOMIZER = apply_filters( 'astha_customizer_data', $ASTHA_CUSTOMIZER );
    //wp_localize_script( 'astha-customizer', 'ASTHA_CUSTOMIZER', $ASTHA_CUSTOMIZER );
}
...
//            $converted[$key] = array(
//                'image' => esc_url( trailingslashit( ASTHA_CUSTOMIZER_URI ) . 'assets/images/' . $key . '.png' ),
//                'name'  => esc_html( $value )
//            );
             ...
             */
            if( is_file( ASTHA_THEME_DIR . 'inc/customizer/assets/images/' . $key . '.png' ) ){
                $converted[$key]['image'] = esc_url( trailingslashit( ASTHA_CUSTOMIZER_URI ) . 'assets/images/' . $key . '.png' );
            }
        }
        return $converted;
    }
