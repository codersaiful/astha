 ...
 * Tempalte: Fullwidth
 */
do_action( 'astha_before_page_template_fullwidth' );
?>
	...
	<main id="primary" class="site-main">
		...
		while ( have_posts() ) :
			the_post();
                         ...
                         * Tempalte: Fullwidth
                         */
                        do_action( 'astha_page_template_fullwidth_top' );
			...
			get_template_part( 'template-parts/content', 'page' );
                         ...
                         * Tempalte: Fullwidth
                         */
                        do_action( 'astha_page_template_fullwidth_bottom' );
 ...
 * Tempalte: Fullwidth
 */
do_action( 'astha_after_page_template_fullwidth' );
